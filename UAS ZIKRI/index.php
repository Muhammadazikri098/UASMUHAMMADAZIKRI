  ...
  <body>
    ...
    <nav class="navbar navbar-light bg-success object-fit-cover border rounded mt-3">
        <div class="container-fluid">
          <a class="navbar-brand"><img src="image/balap.jpg " width="50" class="rounded float-start" alt=""></a>
    ...
    <div class="container">
        ...
        <figcaption class="blockquote-footer">
          <cite title="Source Title">IMI Ikatan Motor Indonesia</cite>
        </figcaption>
      </figure>
      <h1>Selamat Datang diwebsite Data Pembalap Jambi</h1>
      <h6>UIN Sulthan Thaha Saifuddin Jambi</h6>
      <p>Racing bukan melulu hobi kasar dan mengganggu, masih ada sebagian kelompok yang justru berperan di lingkungan. Jadi Anda bisa menannggalkan pikiran buruk dengan anak drag racing. Sejumlah anak racing bahkan mempunyai kebijaksanaan, semangat, cinta, dan impian yang mungkin membuat takjud.</p>
        <a href="login.php">
        ...
        <img src="image/balap.jpg" style="background-size:cover" >
    </div>
    </body>
</html>