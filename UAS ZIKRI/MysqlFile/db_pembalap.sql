...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 11 Des 2023 pada 20.41
...
--
-- Database: `db_pembalap`
--

-- --------------------------------------------------------

--
-- Struktur dari tabel `data_pembalap`
--

CREATE TABLE `data_pembalap` (
  `id` int(11) NOT NULL,
  ...
  `kelas` enum('250 cc','500 cc','1000 cc') NOT NULL,
  `gambar` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data untuk tabel `data_pembalap`
--

INSERT INTO `data_pembalap` (`id`, `nama`, `alamat`, `email`, `tanggal_lahir`, `jenis_kelamin`, `telepon`, `debut`, `kelas`, `gambar`) VALUES
(4, 'Muhammad risky', 'Jambi', 'risky@gmail.com', '1111-11-11', 'Laki-laki', '079900685', '02020220', '500 cc', '6577659a79fb8.jpg');
...
--
-- Indeks untuk tabel `data_pembalap`
--
ALTER TABLE `data_pembalap`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT untuk tabel `data_pembalap`
--
ALTER TABLE `data_pembalap`
